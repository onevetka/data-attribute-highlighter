...
import { ValidateAttributeNameAction, ValidationAction } from "./validationAction";
...
function validateAttributeName(state: ValidationState, action: ValidateAttributeNameAction): ValidationState {
